...
<script>
	...
	import storeMsg from "./lookViews/store-sign-detail.vue"
	import storeMap2 from "./lookViews/store-sign-detail-map.vue"
	...
	export default{
		...
		//					lat: 23.14003
						...
						way:[{lng: 113.3831,lat: 23.13013},
							{lng: 113.3831,lat: 23.1273},],
						initLocation: false,
						circlePath: { //圆形区域
							center: {
								lng: 113.3831,
					...
					codeNum:2,
					num:1,
					position:"广东省广州市天河区棠下二社新围中心路17号锦达信商务大厦A座",
					away:"0.55",
					state:"异常",
				},
			}
