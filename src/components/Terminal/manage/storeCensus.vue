...
<script>
	import search from "./censusViews/store-list-search.vue"; /*搜索*/
	import inputcode from "./censusViews/inputcode.vue" /*联想搜索框*/
	import list from "./censusViews/store-visit-list.vue" /*列表*/
	export default {
		data() {
			return {
