...
<script>
	import search from "./visitViews/store-visit-search.vue"; /*搜索*/
	import inputcode from "./visitViews/inputcode.vue" /*联想搜索框*/
	import list from "./visitViews/store-visit-list.vue" /*列表*/
	export default {
		data() {
			return {
