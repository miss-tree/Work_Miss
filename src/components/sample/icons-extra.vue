		...
		<div class="mui-content">
			<div class="mui-content-padded">
				...
				<div class="flex-container">
					...
					<a><span class="mui-icon-extra mui-icon-extra-trend"></span></a></br>
					...
					<a><span class="mui-icon-extra mui-icon-extra-gift"></span></a></br>
					...
					<a><span class="mui-icon-extra mui-icon-extra-calendar"></span></a></br>
