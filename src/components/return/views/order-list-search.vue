          ...
          <div class="formTable">
            ...
            <div class="form_div padding_tb_5px">
              <div class="alertRow">
                <div class="form_row_right flex justify_content">
                  <label>
                    <input type="checkbox" name="CHECKSTATE" value="未发货" v-model="CHECKSTATE">
                    <div class="row_button">未发货</div>
                  </label>
                  <label>
                    <input type="checkbox" name="CHECKSTATE" value="物流中" v-model="CHECKSTATE">
                    <div class="row_button">物流中</div>
                  </label>
                  <label>
                    <input type="checkbox" name="CHECKSTATE" value="已签收" v-model="CHECKSTATE">
                    <div class="row_button">已签收</div>
                  </label>
                </div>
              </div>
            </div>
