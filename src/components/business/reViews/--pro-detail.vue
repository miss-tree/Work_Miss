  ...
  <div>
    <div class v-for="(item,index) in INFOR">
      ...
      <div class="form_div">
        ...
        <div class="form_row">
          ...
          <div class="form_row_right">{{item.payfor.toFixed(2)}}元</div>
        </div>
        <div class="form_row">
              ...
              <div class="content">
                <div class="form_div">
                  ...
                  <div class="form_row">
                    ...
                    <div class="form_row_right">{{showInfo.payfor.toFixed(2)}}元</div>
                  </div>
                  <div class="form_row">
                    <label class="form_row_left huise">
                      	销售金额
                    ...
                    <div class="form_row_right">{{showInfo.sale.toFixed(2)}}元</div>
                  </div>
                  <div class="form_row">
                    <label class="form_row_left huise">
                      退货金额
                    ...
                    <div class="form_row_right">{{showInfo.price.toFixed(2)}}元</div>
                  </div>
                  <div class="form_row">
                    <label class="form_row_left huise">
                      核销金额
                    ...
                    <div class="form_row_right">{{showInfo.real.toFixed(2)}}元</div>
                  </div>
                  <div class="form_row">
                    <label class="form_row_left huise">
                      所属公司
                  ...
                  <div class="form_row">
                    ...
                    <div class="form_row_right">{{showInfo.part}}</div>
                  </div>
                </div>
              </div>
    ...
    <div class="mui-bar-tab mui-bar" style="height: 40px;padding: 0 15px;">
      <div class="bottomWidth flex justify_content">
        ...
        <span class="span_15px" style="margin-left: 5px;">
        	应收款金额：{{MONEY.toFixed(2)}}
        </span>
      </div>
    </div>
  </div>
...
export default {
  data() {
    return {
      showAct: false,
      showInfo: {name:'',payfor:0,sale:0,price:0,real:0,com:'',part:''}
    };
  },
  props: ["INFOR"],
  computed: {
    MONEY() {
      /*合计金额*/
      return this.INFOR.map(row => row.payfor).reduce(
