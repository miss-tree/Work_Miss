		...
		<div style="display: flex;width: 100%;height: calc(100vh - 44px);top: 44px;">
			...
			<div style="width: calc(70% - 1px);background-color: #fff;">
					...
					<ul class="mui-table-view">
						...
						<li class="mui-table-view-cell mui-selected" id="111">
							<label class="screen_check_li" for="111">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="现金" />
								现金
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="电汇" />
								电汇
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="支票" />
								支票
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="承兑汇票" />
								承兑汇票
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="返利抵货款" />
								返利抵货款
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="领导签批" />
								领导签批
								<i class="check_radio"></i>
							</label>
						</li>
				...
				<div v-show="curIndex==3">
					...
					<div id="dateTable" 
						v-if="PRONAME.length!=0"
						class="hidden300px">
						<div class="Row">
							<div class="col_30">序号</div> 
							<div class="col_70">产品</div> 
						</div> 
						<div id="table" v-for="(item,index) in PRONAME">
							<div class="row">
								<div class="col_30" style="text-align: center;">
									{{index+1}}
								</div> 
								<div class="col_70">
									<span class="span_12px nowrap">{{item}}</span>
								</div> 
							</div>
						</div>
					</div>
