			...
			<div style="width: calc(70% - 1px);background-color: #fff;">
					...
					<ul class="mui-table-view">
						...
						<li class="mui-table-view-cell mui-selected" id="111">
							<label class="screen_check_li" for="111">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="代理" />
								代理
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="贴牌" />
								贴牌
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell" id="222">
							<label class="screen_check_li" for="222">
								<input class="playnone" type="radio" name="ss" v-model="dateCheck"  value="自营" />
								自营
								<i class="check_radio"></i>
							</label>
						</li>
				...
				<div v-show="curIndex==5">
					<ul class="mui-table-view">
						<li class="mui-table-view-cell">
							<label class="screen_check_li">
								<input class="playnone" type="radio" name="handle" v-model="HANDLE"  value="控销" />
								控销
								<i class="check_radio"></i>
							</label>
						</li>
						<li class="mui-table-view-cell mui-selected">
							<label class="screen_check_li">
								<input class="playnone" type="radio" name="handle" v-model="HANDLE"  value="流通" />
								流通
								<i class="check_radio"></i>
							</label>
						</li>
