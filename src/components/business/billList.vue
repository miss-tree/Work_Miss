...
<script>
	import inputcode from "./billViews/inputcode.vue"
	import check from "./billViews/check.vue"
	import lookView from "./billViews/lookView.vue" /*查看*/
	import list from "./billViews/bill-list.vue" /*列表*/
	export default{
		data(){
			return{
				select1:true,
