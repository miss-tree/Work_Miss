    ...
    <div class v-for="(item,index) in INFOR">
            ...
            <div class="alert_div">
              <div>
                ...
                <div class="content" style="padding-bottom: 60px;">
                  <div class="form_div" style="height: 250px;overflow-y: scroll;">
                    <div class="form_row">
                      <label class="form_row_left huise">
                       	 产品名称
                        <span class="span_red"></span>
                    ...
                    <div class="form_row">
                      ...
                      <div class="form_row_right">{{showInfo.ph}}</div>
                    </div>
                    <div class="form_row">
                      <label class="form_row_left huise" id="where">
                     	   生产日期
                      ...
                      <div class="form_row_right">{{showInfo.beginTime}}</div>
                    </div>
                    <div class="form_row">
                      <label class="form_row_left huise" id="person">
                    	    有效日期
                      ...
                      <div class="form_row_right">{{showInfo.endTime}}</div>
                    </div>
                    <div class="form_row">
                      <label class="form_row_left huise" id="phone">
                        	可开票余数
                      ...
                      <div class="form_row_right">{{showInfo.picNum}}</div>
                    </div>
                  </div>
                </div>
      ...
      <div class="mui-bar-tab mui-bar" style="height: 40px;padding: 0 15px;">
        <div class="bottomWidth flex justify_content">
          ...
          <span class="span_15px" style="margin-left: 5px;">合计金额：{{MONEY}}</span>
        </div>
      </div>
    </div>
  </div>
