<template>
	<div>
		...
		<header class="mui-bar mui-bar-nav back_title">
	      ...
	      <h1 class="mui-title">产品批号查询列表</h1>
	    </header>
	    <!--头部结束-->
	    	...
	    	<div class="screen">
		    	...
		    	<div class="screen_tab">
		    		<div @click="changeTree">
		    			<span style="opacity: 0;white-space: nowrap;">多选</span>
...
<script>
	import inputcode from "./batchViews/inputcode.vue"
	import check from "./batchViews/check.vue"
	import lookView from "./batchViews/lookView.vue" /*查看*/
	import list from "./batchViews/batch-list.vue" /*列表*/
	export default{
		data(){
			return{
				select1:true,
